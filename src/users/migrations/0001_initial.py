    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('ru', 'РУ'), ('ua', 'УКР')], default='ua', max_length=3)),
                ('gender', models.CharField(choices=[('F', 'Жінка'), ('M', 'Чоловік')], max_length=1)),
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None)),
                ('date_birthday', models.DateField(blank=True, null=True)),
                ('city', models.CharField(max_length=12)),
                ('role', models.CharField(choices=[('user', 'User'), ('admin', 'Admin')], max_length=6)),
